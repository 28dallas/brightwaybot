...
class SimpleDemoTrader:
    ...
    def run_demo(self, num_ticks=20):
        ...
        for tick in range(num_ticks):
            ...
            if self.balance < 1.0:
                print("Balance too low, stopping demo")
                break
...
if __name__ == "__main__":
    ...
    trader = SimpleDemoTrader()
    results = trader.run_demo(20)  # Run 20 ticks for quick demo
